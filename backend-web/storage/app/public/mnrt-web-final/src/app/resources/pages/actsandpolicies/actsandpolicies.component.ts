...
@Component({
  selector: 'mnrt-actsandpolicies',
  templateUrl: './actsandpolicies.component.html',
  styleUrls: ['./actsandpolicies.component.scss']
})
export class ActsandpoliciesComponent implements OnInit {
  ...
  title: string = "ACTS AND POLICIES";
