...
@Component({
  selector: 'mnrt-otherpublications',
  templateUrl: './otherpublications.component.html',
  styleUrls: ['./otherpublications.component.scss']
})
export class OtherpublicationsComponent implements OnInit {
