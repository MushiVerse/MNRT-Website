...
@Component({
  selector: 'mnrt-cms-wildlife-about-add',
  templateUrl: './cms-wildlife-about-add.component.html',
  styleUrls: ['./cms-wildlife-about-add.component.scss']
})
export class CmsWildlifeAboutAddComponent implements OnInit {

  constructor(
    public matDialogRef: MatDialogRef<CmsWildlifeAboutAddComponent>,
