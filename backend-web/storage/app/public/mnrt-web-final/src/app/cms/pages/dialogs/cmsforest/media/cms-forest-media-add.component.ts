...
@Component({
  selector: 'mnrt-cms-forest-media-add',
  templateUrl: './cms-forest-media-add.component.html',
  styleUrls: ['./cms-forest-media-add.component.scss']
})
export class CmsForestMediaAddComponent implements OnInit {

  constructor(public matDialogRef: MatDialogRef<CmsForestMediaAddComponent>,
