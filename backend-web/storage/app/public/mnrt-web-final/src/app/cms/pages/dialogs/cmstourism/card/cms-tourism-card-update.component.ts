...
@Component({
  selector: 'mnrt-cms-tourism-card-update',
  templateUrl: './cms-tourism-card-update.component.html',
  styleUrls: ['./cms-tourism-card-update.component.scss']
})
export class CmsTourismCardUpdateComponent implements OnInit {

    //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsTourismCardUpdateComponent>, 
