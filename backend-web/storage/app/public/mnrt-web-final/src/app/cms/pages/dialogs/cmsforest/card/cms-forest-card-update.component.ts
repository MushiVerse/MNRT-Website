...
@Component({
  selector: 'mnrt-cms-forest-card-update',
  templateUrl: './cms-forest-card-update.component.html',
  styleUrls: ['./cms-forest-card-update.component.scss']
})
export class CmsForestCardUpdateComponent implements OnInit {

     //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsForestCardUpdateComponent>, 
