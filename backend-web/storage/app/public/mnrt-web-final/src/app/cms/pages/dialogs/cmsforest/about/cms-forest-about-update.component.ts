...
@Component({
  selector: 'mnrt-cms-forest-about-update',
  templateUrl: './cms-forest-about-update.component.html',
  styleUrls: ['./cms-forest-about-update.component.scss']
})
export class CmsForestAboutUpdateComponent implements OnInit {

  
  //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, public matDialogRef: MatDialogRef<CmsForestAboutUpdateComponent>, private spinner: SpinnerService, private cmsService: CmsserviceService, private message: MessagesService, private httpClient: HttpClient) { }
