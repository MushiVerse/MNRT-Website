...
@Component({
  selector: 'mnrt-cms-antiquities-about-add',
  templateUrl: './cms-antiquities-about-add.component.html',
  styleUrls: ['./cms-antiquities-about-add.component.scss']
})
export class CmsAntiquitiesAboutAddComponent implements OnInit {

  constructor(public matDialogRef: MatDialogRef<CmsAntiquitiesAboutAddComponent>, private spinner: SpinnerService, private cmsService: CmsserviceService, private message: MessagesService, private httpClient: HttpClient) { }
