...
import { CmsTourismCardUpdateComponent } from '../cms-tourism-card-update.component';

@Component({
  selector: 'mnrt-cms-tourism-card-editor',
  templateUrl: './cms-tourism-card-editor.component.html',
  styleUrls: ['./cms-tourism-card-editor.component.scss']
})
export class CmsTourismCardEditorComponent implements OnInit {
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsTourismCardUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourismAbout();
     });
