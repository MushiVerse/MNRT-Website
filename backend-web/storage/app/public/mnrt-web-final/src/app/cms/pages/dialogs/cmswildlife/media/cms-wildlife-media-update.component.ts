...
@Component({
  selector: 'mnrt-cms-wildlife-media-update',
  templateUrl: './cms-wildlife-media-update.component.html',
  styleUrls: ['./cms-wildlife-media-update.component.scss']
})
export class CmsWildlifeMediaUpdateComponent implements OnInit {

  //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsWildlifeMediaUpdateComponent>, 
