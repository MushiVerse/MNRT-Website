...
@Component({
  selector: 'mnrt-cms-tourism-about-update',
  templateUrl: './cms-tourism-about-update.component.html',
  styleUrls: ['./cms-tourism-about-update.component.scss']
})
export class CmsTourismAboutUpdateComponent implements OnInit {

  //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, public matDialogRef: MatDialogRef<CmsTourismAboutUpdateComponent>, private spinner: SpinnerService, private cmsService: CmsserviceService, private message: MessagesService, private httpClient: HttpClient) { }
