...
@Component({
  selector: 'mnrt-cms-tourism-about-add',
  templateUrl: './cms-tourism-about-add.component.html',
  styleUrls: ['./cms-tourism-about-add.component.scss'],
})
export class CmsTourismAboutAddComponent implements OnInit {
  constructor(
    public matDialogRef: MatDialogRef<CmsTourismAboutAddComponent>,
