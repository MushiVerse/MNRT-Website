...
@Component({
  selector: 'mnrt-delete-management',
  templateUrl: './delete-management.component.html',
  styleUrls: ['./delete-management.component.scss']
})
export class DeleteManagementComponent implements OnInit {

  row: any = [];
  constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, public matDialogRef: MatDialogRef<DeleteManagementComponent>, private messages: MessagesService, private cmsService: CmsserviceService, public spinner: SpinnerService ) { 
  ...
  onDelete(){
    ...
    this.cmsService.deleteManagementById(this.row.id).subscribe(result=>{
