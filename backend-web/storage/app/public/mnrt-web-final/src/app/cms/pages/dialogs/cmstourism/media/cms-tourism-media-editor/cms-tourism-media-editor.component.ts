...
import { CmsTourismMediaUpdateComponent } from '../cms-tourism-media-update.component';

@Component({
  selector: 'mnrt-cms-tourism-media-editor',
  templateUrl: './cms-tourism-media-editor.component.html',
  styleUrls: ['./cms-tourism-media-editor.component.scss']
})
export class CmsTourismMediaEditorComponent implements OnInit {
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsTourismMediaUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourism();
     });
