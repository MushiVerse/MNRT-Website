...
import { CmsTourismSliderUpdateComponent } from '../cms-tourism-slider-update.component';

@Component({
  selector: 'mnrt-cms-tourism-slider-editor',
  templateUrl: './cms-tourism-slider-editor.component.html',
  styleUrls: ['./cms-tourism-slider-editor.component.scss']
})
export class CmsTourismSliderEditorComponent implements OnInit {
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsTourismSliderUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourism();
     });
