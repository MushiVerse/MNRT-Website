...
import { CmsForestAboutUpdateComponent } from '../cms-forest-about-update.component';

@Component({
  selector: 'mnrt-cms-forest-about-editor',
  templateUrl: './cms-forest-about-editor.component.html',
  styleUrls: ['./cms-forest-about-editor.component.scss']
})
export class CmsForestAboutEditorComponent implements OnInit {
  ...
  constructor(private cmsService: CmsserviceService, 
    private messagesService: MessagesService, private dialog: MatDialog, public spinner: SpinnerService) { }
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsForestAboutUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourismAbout();
     });
