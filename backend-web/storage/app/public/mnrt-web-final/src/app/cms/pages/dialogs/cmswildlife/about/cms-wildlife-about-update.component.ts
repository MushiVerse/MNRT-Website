...
@Component({
  selector: 'mnrt-cms-wildlife-about-update',
  templateUrl: './cms-wildlife-about-update.component.html',
  styleUrls: ['./cms-wildlife-about-update.component.scss']
})
export class CmsWildlifeAboutUpdateComponent implements OnInit {


  //2
  constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, public matDialogRef: MatDialogRef<CmsWildlifeAboutUpdateComponent>, private spinner: SpinnerService, private cmsService: CmsserviceService, private message: MessagesService, private httpClient: HttpClient) { }
  ...
  ngOnInit(): void {
    ...
    this.image_linkurl = this.data.row.about_img;
    ...
    this.NewForm = new FormGroup({
      ...
      about_description: new FormControl(this.data.row.about_description,[Validators.required, Validators.minLength(5)]),
  ...
  onSubmit(){
    ...
    let newObj = '{"about_description": "'+this.NewForm.value.about_description.replace(/"/g, "'")+'",'+
      '"about_img": "'+this.data.row.about_img+'",'+
      '"created_by": null,'+
