...
@Component({
  selector: 'mnrt-cms-wildlife-slider-update',
  templateUrl: './cms-wildlife-slider-update.component.html',
  styleUrls: ['./cms-wildlife-slider-update.component.scss']
})
export class CmsWildlifeSliderUpdateComponent implements OnInit {

       //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsWildlifeSliderUpdateComponent>, 
