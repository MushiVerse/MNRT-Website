...
import { CmsWildlifeAboutUpdateComponent } from '../cms-wildlife-about-update.component';

@Component({
  selector: 'mnrt-cms-wildlife-about-editor',
  templateUrl: './cms-wildlife-about-editor.component.html',
  styleUrls: ['./cms-wildlife-about-editor.component.scss']
})
export class CmsWildlifeAboutEditorComponent implements OnInit {
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsWildlifeAboutUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourismAbout();
     });
