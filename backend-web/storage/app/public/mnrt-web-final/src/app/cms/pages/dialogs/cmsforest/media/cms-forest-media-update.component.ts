...
@Component({
  selector: 'mnrt-cms-forest-media-update',
  templateUrl: './cms-forest-media-update.component.html',
  styleUrls: ['./cms-forest-media-update.component.scss']
})
export class CmsForestMediaUpdateComponent implements OnInit {

   //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsForestMediaUpdateComponent>, 
