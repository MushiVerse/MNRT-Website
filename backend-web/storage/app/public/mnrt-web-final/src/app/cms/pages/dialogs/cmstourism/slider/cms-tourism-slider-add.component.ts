...
@Component({
  selector: 'mnrt-cms-tourism-slider-add',
  templateUrl: './cms-tourism-slider-add.component.html',
  styleUrls: ['./cms-tourism-slider-add.component.scss']
})
export class CmsTourismSliderAddComponent implements OnInit {

  constructor(
    public matDialogRef: MatDialogRef<CmsTourismSliderAddComponent>,
