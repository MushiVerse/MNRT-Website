...
@Component({
  selector: 'mnrt-cms-forest-card-add',
  templateUrl: './cms-forest-card-add.component.html',
  styleUrls: ['./cms-forest-card-add.component.scss']
})
export class CmsForestCardAddComponent implements OnInit {

  constructor(
    public matDialogRef: MatDialogRef<CmsForestCardAddComponent>,
