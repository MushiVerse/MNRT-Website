...
@Component({
  selector: 'mnrt-cms-wildlife-slider-add',
  templateUrl: './cms-wildlife-slider-add.component.html',
  styleUrls: ['./cms-wildlife-slider-add.component.scss']
})
export class CmsWildlifeSliderAddComponent implements OnInit {

  constructor(
    public matDialogRef: MatDialogRef<CmsWildlifeSliderAddComponent>,
