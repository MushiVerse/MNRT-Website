...
@Component({
  selector: 'mnrt-cms-forest-slider-update',
  templateUrl: './cms-forest-slider-update.component.html',
  styleUrls: ['./cms-forest-slider-update.component.scss']
})
export class CmsForestSliderUpdateComponent implements OnInit {

  
      //2
constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, 
public matDialogRef: MatDialogRef<CmsForestSliderUpdateComponent>, 
