...
@Component({
  selector: 'mnrt-cms-wildlife-media-add',
  templateUrl: './cms-wildlife-media-add.component.html',
  styleUrls: ['./cms-wildlife-media-add.component.scss']
})
export class CmsWildlifeMediaAddComponent implements OnInit {

  constructor(public matDialogRef: MatDialogRef<CmsWildlifeMediaAddComponent>,
