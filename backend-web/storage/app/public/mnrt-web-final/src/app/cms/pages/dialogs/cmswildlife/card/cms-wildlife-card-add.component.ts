...
@Component({
  selector: 'mnrt-cms-wildlife-card-add',
  templateUrl: './cms-wildlife-card-add.component.html',
  styleUrls: ['./cms-wildlife-card-add.component.scss']
})
export class CmsWildlifeCardAddComponent implements OnInit {

  constructor(
    public matDialogRef: MatDialogRef<CmsWildlifeCardAddComponent>,
