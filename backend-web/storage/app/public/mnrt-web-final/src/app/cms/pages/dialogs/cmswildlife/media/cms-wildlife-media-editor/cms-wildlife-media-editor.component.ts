...
import { CmsWildlifeMediaUpdateComponent } from '../cms-wildlife-media-update.component';

@Component({
  selector: 'mnrt-cms-wildlife-media-editor',
  templateUrl: './cms-wildlife-media-editor.component.html',
  styleUrls: ['./cms-wildlife-media-editor.component.scss']
})
export class CmsWildlifeMediaEditorComponent implements OnInit {
  ...
  onUpdate(row:any){
    const dialogConfig = new MatDialogConfig();
     ...
     this.dialog.open(CmsWildlifeMediaUpdateComponent, dialogConfig).afterClosed().subscribe(dialogData=>{
       this.getTourism();
     });
